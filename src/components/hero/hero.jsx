    ...
    <React.Fragment>
      <div className="parent_hero">
        ...
        <div className=" tag-hero-mobile">
          ...
          <img
            src="/images/electroverse-logo.png"
            alt="srmvec logo"
            width="60vw"
            height="60vh"
          ...
          <div className="right_side">
            ...
            >
              ...
              <div className="flex flex-col ">
                <p className="text-white pt-[2vh] text-[1vw] venue-text-mobile">
                  Thadomal Shahani Engineeing College
                </p>
                <p className="text-white  text-[0.8vw] ">
                P. G. Kher Marg, 32nd Road, Marg, Off Linking Rd, Bandra West, Mumbai - 400050
                </p>
            ...
            <div className="col6 animated-div">
              ...
              <div className="flex items-start justify-between flex-col">
                <p className="text14">TSEC, EXTC Department</p>
                <p className="text15">Electroverse Commitee</p>
